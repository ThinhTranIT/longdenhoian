	              ...
	              <div class="navbar navbar-inverse" role="banner">
	                  <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
	                    <ul class="nav navbar-nav">
	                      <li class="dropdown">
	                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}else{echo "Tài Khoản";} ?><b class="caret"></b></a>
				...
				<ul class="nav">
                    ...
                    <li class="submenu">
                		<a href="">
                     	...
                     	<!-- Sub menu -->
                     	<ul>
                        	<li><a href="<?php echo base_url('quanlisp');?>">Danh Sách Sản Phẩm</a></li>
                          <li><a href="<?php echo base_url('quanlisp/dsloai_sp');?>">Danh Sách Loại Sản phẩm</a></li>
                          <li><a href="<?php echo base_url('quanlisp/themsanpham');?>">Thêm Sản Phẩm</a></li>
                          <li><a href="<?php echo base_url('quanlisp/them_loai_sp');?>">Thêm Loại Sản Phẩm</a></li>
                    ...
                    <li class="submenu">
                         ...
                         <!-- Sub menu -->
                         <ul>
                            <li><a href="<?php echo base_url('tintuc/ds_tin');?>">Danh Sách Tin</a></li>
                            <li><a href="<?php echo base_url('tintuc/them_tin');?>">Thêm Tin</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
...
<!-- end chèn editor -->
											...
											<div class="form-group">
										  	...
										  	<div class="form-group">
										    	...
										    	<div class="col-sm-3">
										    		<input type="text" size="48" name="urlanhsp1" class="form-control" id="url1" value="<?php if(isset($product['0']['mauanhsp1'])){ echo $product['0']['anhsp1'];} else { echo null;}?>"> 
											...
											<!-- anh 111 -->
										  	<div class="form-group">
										    	...
										    	<div class="col-sm-3">
										    		<input type="text" size="48" name="urlanhsp2" class="form-control" id="url1" value="<?php if(isset($product['0']['mauanhsp2'])){ echo $product['0']['anhsp2'];} else { echo null;}?>"> 
											...
											<!-- anh 111 -->
										  	<div class="form-group">
										    	...
										    	<div class="col-sm-3">
										    		<input type="text" size="48" name="urlanhsp3" class="form-control" id="url1" value="<?php if(isset($product['0']['mauanhsp3'])){ echo $product['0']['anhsp3'];} else { echo null;}?>"> 
										  	...
										  	<div class="form-group">
										    	...
										    	<div class="col-sm-3">
										    		<input type="text" size="48" name="urlanhsp4" class="form-control" id="url1" value="<?php if(isset($product['0']['mauanhsp4'])){ echo $product['0']['anhsp4'];} else { echo null;}?>"> 
    ...
    <script src="<?php echo base_url(); ?>asset/js/bootstrap-formhelpers.min.js"></script>

    <script src="<?php echo base_url(); ?>asset/js/bootstrap-select.min.js"></script>

    <script src="<?php echo base_url(); ?>asset/js/custom.js"></script>
    <script src="<?php echo base_url(); ?>asset/js/forms.js"></script>
  </body>
</html>