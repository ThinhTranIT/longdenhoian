...
{
	function ckeditor($name, $content, $toolbar = 'standard', $language = 'vi', $width = 'auto', $height = 400)
	{
		...
		if(!$ckeditor_loaded)
		{
			$code.= '<script type="text/javascript" src="'.base_url().'asset/ckeditor/ckeditor.js"></script>';
	...
	config.filebrowserImageBrowseUrl 	= '".base_url()."asset/ckfinder/ckfinder.html';
	";
